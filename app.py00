...
#  • Settings, Snapshot
#  • Editor (➕ nu med Bucket + "spara till Sheets & hämta från Yahoo")
#  • Lägg till ticker (➕ nu med Bucket, EPS 1Y/2Y, Rev 1Y/2Y)
...
# ============================================================
# Batch (Massuppdatering Yahoo) — oförändrad (använder _build_updates_from_yahoo)
# ============================================================
