...
# ============================================================
# Del 1/5 slut — fortsätt i Del 2/5 (datainsamling & beräkningsmotor 1/2)
# ============================================================

# ============================================================
# app.py — Del 2/5 — Datainsamling & beräkningsmotor (1/2)
...
# ============================================================
# (fortsätt i Del 3/5 — Datainsamling & beräkningsmotor (2/2))
# ============================================================

# ============================================================
# app.py — Del 3/5 — Datainsamling & beräkningsmotor (2/2)
...
# ============================================================
# (fortsätt i Del 4/5 — Portfölj, P/L & utdelningar)
# ============================================================

# ============================================================
# app.py — Del 4/5 — Portfölj, P/L & utdelningar
#  • Portföljtabell (GAV i SEK, MV i SEK, P/L kr & %, Årlig utd. (SEK), /månad)
#  • Källskatt: USD 15%, CAD 15%, NOK 25% (kan överskuggas av Settings i Del 5)
...
# ============================================================
# app.py — Del 5/5 — Main & vyer
#  • Settings, Batch, Snapshot, Editor, Portfölj, Analys, Ranking
#  • ➕ Ny vy: "Lägg till ticker" (skapar ny rad i DATA, valfritt med Yahoo-prefill)
#  • Överskuggar källskatt-funktionen med Settings-bladets värden
# ============================================================
...
def page_editor():
    ...
    if st.button("💾 Spara rad till DATA"):
        try:
            ...
            st.success("Sparat i minnet. Använd sidopanelen för att skriva till Google Sheets.")
        except Exception as e:
...
def _build_updates_from_yahoo(ticker: str, existing_row: pd.Series):
    ...
    # Rensa bort None/NaN/tom strängar:
    out = {}
...
def page_analysis():
    ...
    tickers = df["Ticker"].dropna().astype(str).unique().tolist()
    tkr = st.selectbox("Välj bolag", tickers, index=0, key="analysis_tkr")
...
# ============================================================
# Batch (Massuppdatering Yahoo) — oförändrad från tidigare Del
# ============================================================
